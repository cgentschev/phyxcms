...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'phyxcms:install';
...
//        }
    ...
    {
        $this->info('>> Welcome to the phyXCMS install wizard! <<');
    }
    ...
    {
        rename(resource_path('views/themes/default'), resource_path('views/themes/' . config('phyxcms.theme_path')));
    }
